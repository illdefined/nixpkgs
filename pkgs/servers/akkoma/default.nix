...
beamPackages.mixRelease rec {
  ...
  src = fetchgit {
    ...
    rev = "v${version}";
    hash = "sha256-mJtgBkoENgDE8KAhtwm4ual8pQnGQRJMvPgkubVTPQM=";
  };
  ...
  mixNixDeps = import ./mix.nix {
    ...
    overrides = (final: prev: {
      ...
      elasticsearch = beamPackages.buildMix rec {
        ...
        src = fetchgit {
          url = "https://akkoma.dev/AkkomaGang/elasticsearch-elixir.git";
      ...
      linkify = beamPackages.buildMix rec {
        ...
        src = fetchgit {
          url = "https://akkoma.dev/AkkomaGang/linkify.git";
      ...
      temple = beamPackages.buildMix rec {
        ...
        src = fetchgit {
          url = "https://akkoma.dev/AkkomaGang/temple.git";
